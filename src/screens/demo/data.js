const data = {
    labels: ['2019W20', '2019W21', '2019W22', '2019W23'],
    datasets: [{
      data: [
        50,
        20,
  ...
  // Mock data object for Stackbar chart
  ...
  export { data, contributionData, pieChartData, progressChartData , stackdata, piedata}